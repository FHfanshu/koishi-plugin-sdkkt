/**
 * A1111 format parser
 * Handles standard Stable Diffusion WebUI parameter format
 */
...
export interface SDMetadata {
    ...
    parameters?: string;
    exifFallback?: Record<string, unknown>;
    // NovelAI specific
 ...
 */
export function serializeA1111Parameters(metadata: SDMetadata): string {
    const parts: string[] = [];
